...
/**
 * Représente un monôme non nul de la forme cx^n,
 * où c est le coefficient (réel non nul) et n l'exposant entier naturel (entier >= 0).
 *
 * <p>Les instances sont immuables : toutes les opérations retournent un nouveau  Monome.</p>
 */
public class Monome {
    ...
    /**
     * Retourne le coefficient du monôme c * x^n.
     *
    ...
    /**
     * Retourne le produit de ce monôme par  autre :
     * (c1·x^n1) * (c2·x^n2) = (c1·c2)·x^(n1+n2).
     *
     ...
     *                               non représentable comme un Monome)
     */
